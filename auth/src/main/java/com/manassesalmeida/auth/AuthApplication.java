package com.manassesalmeida.auth;
...
import com.manassesalmeida.auth.repository.PermissionRepository;
...
public class AuthApplication {
	...
	private void initUsers(UserRepository userRepository, PermissionRepository permissionRepository,
		...
		User find = userRepository.findByUsername("user01");
		if (find == null) {
